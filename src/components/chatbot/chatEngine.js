...
const INTENTS = {
  ...
  voice_agents: [
    'voice agent', 'voice ai', 'ai voice', 'ai caller', 'auto call', 'automated call',
    'automated calling', 'phone bot', 'voice bot', 'ai phone', 'robocall',
    'calls leads', 'call my leads', 'call leads automatically', 'outbound calling',
    'inbound call', 'voice automation', 'phone automation', 'calling system',
    'phone agent', 'ai receptionist', 'virtual receptionist', 'answer the phone',
    'follow up by phone', 'follow up with a call', 'instant call', 'call back',
  ],
  real_estate: [
    'real estate', 'property', 'realtor', 'estate agent', 'real estate agent',
    'real estate agency', 'properties', 'listings', 'buyers', 'sellers',
    'mortgage', 'rental', 'landlord', 'tenant', 'property management',
    'housing', 'house', 'apartment', 'condo', 'commercial property',
    'real estate automation', 'property leads', 'real estate leads',
    'mls', 'zillow', 'rightmove', 'zoopla',
  ],
  systems: [
    'tell me more', 'tell me about', 'your systems', 'how does it work',
    'explain', 'what exactly', 'more info', 'more information', 'elaborate',
    'break it down', 'walk me through', 'what are your', 'overview',
    'what is upgpt', 'what do you', 'how do you', 'what can',
  ],
}
...
const R = {
  ...
  services: {
    en: `Here's what we build at UpGPT Systems — and more importantly, what each one does for your business:\n\n**AI Website Chatbot**\n*Problem:* Visitors land on your site and leave without engaging.\n*Solution:* A 24/7 AI agent that captures, qualifies, and books them before they bounce.\n*Outcome:* More booked calls from the same traffic — no extra ad spend.\n\n**WhatsApp AI Automation**\n*Problem:* Leads message you and wait hours for a reply — then go cold.\n*Solution:* Instant AI response the moment someone reaches out, qualifying and booking automatically.\n*Outcome:* 98% open rate vs 22% for email. Leads stay warm.\n\n**CRM Automation**\n*Problem:* Leads fall through the cracks across different channels.\n*Solution:* Every lead scored, tracked, and followed up automatically in one pipeline.\n*Outcome:* Zero leads lost. Full visibility over your entire funnel.\n\n**AI Voice Agents**\n*Problem:* Calling leads manually is slow, inconsistent, and expensive.\n*Solution:* AI that calls and follows up with leads instantly — day or night.\n*Outcome:* Faster response time, higher contact rate, more closed deals.\n\n**Real Estate Automation**\n*Problem:* Property leads go cold within minutes if not followed up.\n*Solution:* Full automation from listing inquiry to booked viewing, 24/7.\n*Outcome:* More viewings, faster pipeline, less admin.\n\nWhat kind of business are you running? I'll point you to what makes the most sense for you.`,
  ...
  fallback: {
    en: `Ha — looks like that one's a bit outside our zone 😄\n\nBut since you're here, let me tell you what we actually do:\n\nAt **UpGPT Systems** we build AI automation systems that capture leads, respond instantly, follow up automatically, and increase conversions — so your business runs 24/7 without extra headcount.\n\nServices include AI chatbots, WhatsApp automation, CRM pipelines, AI voice agents, and real estate automation.\n\nHave a business question I can help with — or want to see what automation would look like for your specific situation?`,
    sq: `Ha — duket sikur kjo është pak jashtë zonës sonë 😄\n\nPor meqë jeni këtu, lëreni të ju tregoj çfarë bëjmë:\n\nTe **UpGPT Systems** ndërtojmë sisteme automatizimi AI që kapin klientë potencialë, përgjigjen menjëherë, ndjekin automatikisht dhe rrisin konvertimet — kështu biznesi juaj funksionon 24/7 pa staf shtesë.\n\nShërbimet përfshijnë chatbot-e AI, automatizim WhatsApp, pipeline CRM, agjentë zanorë AI dhe automatizim për pasuri të paluajtshme.\n\nA keni një pyetje biznesi me të cilën mund t'ju ndihmoj — apo doni të shihni si do të dukej automatizimi për situatën tuaj specifike?`,
    es: `Ja — parece que eso está un poco fuera de nuestra zona 😄\n\nPero ya que estás aquí, déjame contarte lo que hacemos:\n\nEn **UpGPT Systems** construimos sistemas de automatización con IA que capturan leads, responden al instante, hacen seguimiento automáticamente y aumentan las conversiones — para que tu negocio funcione 24/7 sin más personal.\n\nLos servicios incluyen chatbots de IA, automatización de WhatsApp, pipelines CRM, agentes de voz IA y automatización inmobiliaria.\n\n¿Tienes alguna pregunta de negocio con la que pueda ayudarte — o quieres ver cómo quedaría la automatización para tu situación específica?`,
    fr: `Ha — on dirait que c'est un peu en dehors de notre zone 😄\n\nMais puisque vous êtes là, laissez-moi vous dire ce que nous faisons:\n\nChez **UpGPT Systems** nous construisons des systèmes d'automatisation IA qui capturent des leads, répondent instantanément, font le suivi automatiquement et augmentent les conversions — pour que votre entreprise tourne 24/7 sans effectif supplémentaire.\n\nNos services incluent les chatbots IA, l'automatisation WhatsApp, les pipelines CRM, les agents vocaux IA et l'automatisation immobilière.\n\nVous avez une question business à laquelle je peux vous aider — ou vous voulez voir à quoi ressemblerait l'automatisation pour votre situation spécifique?`,
    de: `Ha — das scheint etwas außerhalb unseres Bereichs zu sein 😄\n\nAber da Sie schon hier sind, lassen Sie mich Ihnen sagen, was wir tun:\n\nBei **UpGPT Systems** bauen wir KI-Automatisierungssysteme, die Leads erfassen, sofort antworten, automatisch nachfassen und die Conversions steigern — damit Ihr Unternehmen 24/7 läuft ohne zusätzliches Personal.\n\nUnsere Leistungen umfassen KI-Chatbots, WhatsApp-Automatisierung, CRM-Pipelines, KI-Sprachagenten und Immobilienautomatisierung.\n\nHaben Sie eine Geschäftsfrage, bei der ich helfen kann — oder möchten Sie sehen, wie Automatisierung für Ihre spezifische Situation aussehen würde?`,
    it: `Ha — sembra che questo sia un po' fuori dalla nostra zona 😄\n\nMa già che sei qui, lasciami spiegarti cosa facciamo:\n\nIn **UpGPT Systems** costruiamo sistemi di automazione AI che catturano lead, rispondono istantaneamente, fanno follow-up automaticamente e aumentano le conversioni — così la tua azienda funziona 24/7 senza personale aggiuntivo.\n\nI servizi includono chatbot AI, automazione WhatsApp, pipeline CRM, agenti vocali AI e automazione immobiliare.\n\nHai una domanda di business con cui posso aiutarti — o vuoi vedere come apparirebbe l'automazione per la tua situazione specifica?`,
  },
  ...
  voice_agents: {
    en: `AI Voice Agents are one of the most powerful things we build — and most businesses don't even know this is possible yet.\n\n**The Problem:**\nCalling leads manually is slow, inconsistent, and expensive. Most leads go cold within the first 5 minutes of not being contacted.\n\n**The Solution:**\nOur AI Voice Agents call your leads automatically — within seconds of them enquiring. The agent speaks naturally, qualifies the lead, answers questions, and books them into your calendar. All without a human on your team lifting a finger.\n\n**The Outcome:**\nFaster response time → higher contact rate → more booked calls → more closed deals. Businesses using our voice agents typically see a 30-50% increase in contact rate compared to manual calling.\n\nThis is included in our **Premium package** and can also be added to Growth. Want to see how it would work for your specific business?`,
  },
  real_estate: {
    en: `Real estate is one of our strongest verticals — we've built automation systems specifically for agencies and agents.\n\n**The Problem:**\nProperty leads go cold fast. A buyer or seller enquires, and if they don't hear back within minutes, they've already moved on to the next agency.\n\n**The Solution:**\nWe build a full automation pipeline — the moment someone enquires on a listing, they get an instant AI response, qualify themselves, and book a viewing or valuation automatically. We can also connect it to your CRM (whether that's HubSpot, GoHighLevel, or anything else) so every lead is tracked and followed up with automatically.\n\nFor agencies with AI Voice Agents, we add instant call-back the moment an enquiry comes in — day or night.\n\n**The Outcome:**\nMore viewings booked from the same leads. Less time spent chasing. A fully automated pipeline from enquiry to appointment.\n\nAre you running an agency or working as an independent agent? That'll help me tailor the recommendation.`,
  },
  systems: {
    en: `Great question — let me break down exactly how our AI systems work.\n\n**What they are:**\nCustom-built AI automation systems designed specifically for your business. Not off-the-shelf tools — everything is built around your products, your leads, and your sales process.\n\n**What problems they solve:**\n- Leads going cold because of slow follow-up\n- Manual tasks eating up your team's time\n- Inconsistent lead qualification\n- Missed opportunities outside business hours\n\n**How they work:**\n1. A lead comes in — from your website, WhatsApp, or a form\n2. The AI responds instantly, 24/7\n3. It qualifies the lead based on your criteria\n4. It books them into your calendar or passes them to your CRM\n5. Everything is tracked and followed up automatically\n\n**The outcome:**\nFaster response time. Higher conversion rate. Fully automated pipeline. More revenue from the same traffic.\n\nWhich part of your business would benefit most from this — lead capture, follow-up, or the full pipeline?`,
  },
}
